...
class Controller:
    ...
    def Show(self, model):
        ...
        while True:
            ...
            # if this receives an event within 20ms, process the event immediately and continue waiting for the next event.
            event, values = self.window.read(20, timeout_key="-timeout-")
            if event != "-timeout-":
